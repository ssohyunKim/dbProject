	...
	<table width="100%" align="center" class="type11">
		<thead>
			<tr class="label">
				...
				<th scope="cols">학점</th>
				<th scope="cols">학기</th>
				<th scope="cols">수업 시간</th>
				<th scope="cols">인원</th>
				<th scope="cols">강의 추가</th>
			</tr>
		</thead>
		<tr>
		</tr>
		<form action="insert_verify.jsp?id=<%=session_id%>" method="post">
			<td align="center"><input type="text" name="c_name" id="in"
				value="수업명"></td>
			<td align="center"><input type="text" name="c_id_no" id="in"
				value="001"></td>
			<td align="center"><input type="text" name="c_unit" id="in"
				value="3"></td>
			<td align="center"><input type="text" name="c_semester"
				style="width: 70px;" id="in" value="1"></td>
			<td align="center"><input type="text" name="c_time" id="in"
				value="1"></td>
			<td align="center"><input type="text" name="c_max"
				style="width: 65px;" id="in"></td>
			<td align="center"><input type="submit" value="추가" id="in_b"
				style="font-family: ppi;" value="1"></td>
		</form>
		</tr>
	</table>
