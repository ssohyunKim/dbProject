...
%> 
		...
		<table border="1" width="100%" align="center" class="type08" >
		<br>
		<tr>
			<th>과목번호</th>
			<th>분반</th>
...
%>
					<tr>
					  ...
					  <td align="center"><a href="insert_verify.jsp?c_name='<%=c_name%>'&c_id=<%= c_id %>&c_id_no=<%= c_id_no %>" id="in_b">신청</a></td>
					</tr>
<%
					}
				%>
...
%> 
		...
		<tr><th style="padding-top: 1%; padding-bottom: 1%;">과목명</th>
			...
			<form action="insert_verify.jsp?id=<%=session_id%>" method="post">
				...
				<td align="center"><input type="text" name="c_time"  id="in" value="교시"></td>
